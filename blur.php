...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="info.php"style="font-weight:bold;">Blur</a>
                </li>
            </ul>
        </div>
        </nav>
		...
		<ul class="topnav" align="center">
            ...
            <br>
            <p>Blur adalah metode filter yang memperhalus sebuah gambar atau tampilan grafis sehingga memberikan kesan buram. Blur biasanya digunakan untuk mengurangi detail atau memperluas tampilan.</p>
            <br>
            <a href="<?= $gambar[0]['gambar']; ?>"download="Blur">
        <img src="<?= $gambar[0]['gambar']; ?>" alt="" style="width: 80%; height : 70%;  filter: blur(7px);
            left: 0%;
            top: 0%;
            bottom: 0%;
            opacity: .9;"></a><br>
