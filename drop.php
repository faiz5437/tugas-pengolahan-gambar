...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="info.php"style="font-weight:bold;">Shadow</a>
                </li>
            </ul>
        </div>
        </nav>
		...
		<ul class="topnav" align="center">
            ...
            <br>
            <p>Drop Shadow adalah efek visual yang terdiri dari elemen gambar yang terlihat seperti bayangan objek, memberi kesan bahwa objek tersebut diangkat diatas objek di belakangannya.</p>
            <br>
        <img src="<?= $gambar[0]['gambar']; ?>" alt="" style="width: 80%; height : 70%; box-shadow: 10px 10px 5px rgb(0, 0, 0);"><br>
            <br>
		</div>
<!-- <footer>
        <div >
