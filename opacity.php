...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="info.php"style="font-weight:bold;">Opacity</a>
                </li>
            </ul>
        </div>
        </nav>
		...
		<ul class="topnav" align="center">
            ...
            <br>
            <p>Opacity adalah mengubah sebuah gambar atau objek menjadi transparan atau kita bisa bilang objek tersebut menjadi tembus pandang.</p>
            <br>
        <img src="<?= $gambar[0]['gambar']; ?>" alt="" style="width: 80%; height : 70%; filter:opacity(30%);"><br>
            <br>
		</div>
<!-- <footer>
        <div >
