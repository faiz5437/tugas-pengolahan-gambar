...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="info.php"style="font-weight:bold;">Hue-rotate</a>
                </li>
            </ul>
        </div>
        </nav>
		...
		<ul class="topnav" align="center">
            ...
            <br>
            <p>Hue-rotate adalah penerapan rotasi rona pada gambar. Nilai yang terkandung di dalamnya adalah jumlah derajat sekitar lingkaran warna sampel pada gambar. 0deg pada hue-rotate adalah default, ini menunjukan gambar asli.</p>
            <br>
        <img src="<?= $gambar[0]['gambar']; ?>" alt="" style="width: 80%; height : 70%; filter:hue-rotate(200deg);"><br>
            <br>
		</div>
<!-- <footer>
        <div >
