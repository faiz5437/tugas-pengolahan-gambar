...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="info.php"style="font-weight:bold;">Saturate</a>
                </li>
            </ul>
        </div>
        </nav>
		...
		<ul class="topnav" align="center">
            ...
            <br>
            <p>Saturate adalah suatu citra yang diberikan pada setiap warna yang muncul pada foto, semakin tinggi nilai yang diberikan pada saturate foto 
                maka warna yang akan dihasilan akan menjadi lebih "menyala".</p>
            <br>
        <img src="<?= $gambar[0]['gambar']; ?>" alt="" style="width: 80%; height : 70%; filter:saturate(15);"><br>
            <br>
		</div>
<!-- <footer>
        <div >
