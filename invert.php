...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="info.php"style="font-weight:bold;">Invert</a>
                </li>
            </ul>
        </div>
        </nav>
		...
		<ul class="topnav" align="center">
            ...
            <br>
            <p>Invert image adalah mengubah nilai grayscale tiap-tiap piksel image menjadi nilai invers nya. Misalnya piksel yang aslinya gelap, nanti akan dijadikan piksel terang dan begitu sebaliknya.</p>
            <br>
        <img src="<?= $gambar[0]['gambar']; ?>" alt="" style="width: 80%; height : 70%; filter:invert(100%);"><br>
            <br>
		</div>
<!-- <footer>
        <div >
