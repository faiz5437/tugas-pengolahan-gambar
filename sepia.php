...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="info.php"style="font-weight:bold;">Sepia</a>
                </li>
            </ul>
        </div>
        </nav>
		...
		<ul class="topnav" align="center">
            ...
            <br>
            <p>Sepia adalah suatu proses foto yang menambahkan tone(warna) ke dalam foto untuk memberikan kesan yang lebih hangat. 
                Efek ini lebih cocok digunakan untuk foto hitam putih, akan membuat foto terlihat menjadi jauh lebih hangat.</p>
            <br>
        <img src="<?= $gambar[0]['gambar']; ?>" alt="" style="width: 80%; height : 70%; filter: sepia(80%);"><br>
            <br>
		</div>
<!-- <footer>
        <div >
